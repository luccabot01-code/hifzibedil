...
const products = [
  {
    src: "/images/programs/2year/canta.png",
    alt: "Program Çantası",
    label: "Çanta",
    desc: "Taşıma kolaylığı sağlayan özel tasarım çanta",
  },
  {
    src: "/images/programs/2year/takvim.png",
    alt: "Program Takvimi",
    label: "Takvim",
    desc: "2 yılın her günü için özel olarak hazırlanmış ezber / tekrar takip takvimi",
  },
  {
  ...
  {
    src: "/images/programs/2year/ayrac.png",
    alt: "Ayraç Seti",
    label: "Ayraç",
...
function ProductShowcase() {
  ...
  return (
    <section className="product-section">
      <SectionTitle>2 Yıllık Program Kiti</SectionTitle>
...
export default function TwoYearProgram() {
  return (
        ...
        <section>
          ...
          >
            <p className="text-earth text-base sm:text-lg leading-relaxed mb-6 max-w-3xl mx-auto text-center">
              Hayattan tamamen soyutlanmayı gerektirmemekle birlikte, vaktinin
              büyük bir bölümünü ezbere ayırabilme imkânına sahip,{" "}
              <span className="font-semibold text-dark">
                azimli ve kararlı bireyler için uygundur.
              </span>
            </p>

            <p className="text-earth text-base sm:text-lg leading-relaxed mb-8 max-w-3xl mx-auto text-center">
              Hafızlık bu süreçte kişinin hayatının önceliği durumunda olmalıdır.
              Bununla birlikte öğrenci, kısmî anlamda öğrenciliğine ve yine kısmî
              anlamda iş hayatına ayrıca çeşitli ilgi alanlarına devam edebilir.
            </p>

            {/* Stat cards — mobile and desktop: side-by-side */}
            <div className="grid grid-cols-3 gap-2 sm:hidden mx-auto w-full">
              <StatCard icon={CalendarDays} value="24 Ay" label="96 Hafta" />
              <StatCard icon={BookOpen} value="30 Sayfa" label="Aylık Yeni Ezber" />
              <StatCard icon={Library} value="15 Cüz" label="Yıllık Yeni Ezber" />
            </div>
