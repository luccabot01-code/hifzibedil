...
const products = [
  {
    src: "/images/programs/4year/canta.png",
    alt: "Program Çantası",
    label: "Çanta",
    desc: "Taşıma kolaylığı sağlayan özel tasarım çanta",
  },
  {
    src: "/images/programs/4year/takvim.png",
    alt: "Program Takvimi",
    label: "Takvim",
    desc: "4 yılın her günü için özel olarak hazırlanmış ezber / tekrar takip takvimi",
  },
  {
  ...
  {
    src: "/images/programs/4year/ayrac.png",
    alt: "Ayraç Seti",
    label: "Ayraç",
...
function ProductShowcase() {
  ...
  return (
    <section className="product-section">
      <SectionTitle>4 Yıllık Program Kiti</SectionTitle>
...
export default function FourYearProgram() {
  return (
        ...
        <section>
          ...
          >
            <p className="text-earth text-base sm:text-lg leading-relaxed mb-6 max-w-3xl mx-auto text-center">
              Orta yoğunlukta bir hayat temposuna sahip, nispeten sakin bir hayat
              süren ve hafızlığa geniş zaman ayırabilecek bireyler için{" "}
              <span className="font-semibold text-dark">
                kıymetli bir imkândır.
              </span>
            </p>

            <p className="text-earth text-base sm:text-lg leading-relaxed mb-8 max-w-3xl mx-auto text-center">
              Hafız olmayı gönülden arzu eden hafif tempolu öğrenciler, çalışma
              hayatı devam eden bireyler ve ev sorumlulukları ile meşgul
              ebeveynler için uygundur.
            </p>

            {/* Stat cards — mobile and desktop: side-by-side */}
            <div className="grid grid-cols-3 gap-2 sm:hidden mx-auto w-full">
              <StatCard icon={CalendarDays} value="49 Ay" label="196 Hafta" />
              <StatCard icon={BookOpen} value="15 Sayfa" label="Aylık Yeni Ezber" />
              <StatCard icon={Library} value="7,5 Cüz" label="Yıllık Yeni Ezber" />
            </div>
